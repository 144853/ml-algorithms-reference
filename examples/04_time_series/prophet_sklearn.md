# Prophet - Scikit-learn Implementation

## 📚 **Quick Reference**

This is the **scikit-learn** implementation of Prophet. For the complete algorithm explanation, mathematical background, and use cases, see:
...
- [Prophet - PyTorch](prophet_pytorch.md)
