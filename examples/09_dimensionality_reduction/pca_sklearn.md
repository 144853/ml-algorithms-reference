...
This is the **scikit-learn** implementation of PCA. For the complete algorithm explanation, mathematical background, and use cases, see:
...
Full implementation: [`09_dimensionality_reduction/pca_sklearn.py`](../../09_dimensionality_reduction/pca_sklearn.py)

Related:
- [PCA - NumPy (from scratch)](pca_numpy.md)
- [PCA - PyTorch](pca_pytorch.md)
