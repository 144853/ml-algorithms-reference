...
This is the **scikit-learn** implementation of DBSCAN. For the complete algorithm explanation, mathematical background, and use cases, see:
...
Full implementation: [`02_classification/dbscan_sklearn.py`](../../02_classification/dbscan_sklearn.py)

Related:
- [DBSCAN - NumPy (from scratch)](dbscan_numpy.md)
- [DBSCAN - PyTorch](dbscan_pytorch.md)
