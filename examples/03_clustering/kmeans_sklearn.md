...
This is the **scikit-learn** implementation of K-Means. For the complete algorithm explanation, mathematical background, and use cases, see:

👉 **[K-Means - Full Documentation](kmeans_numpy.md)**
...
Full implementation: [`02_classification/kmeans_sklearn.py`](../../02_classification/kmeans_sklearn.py)

Related:
- [K-Means - NumPy (from scratch)](kmeans_numpy.md)
- [K-Means - PyTorch](kmeans_pytorch.md)
